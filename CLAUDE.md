...
**Current strategic plan (2026-05-05):** Path A (4P tuner retool) + Path C (MCTS sim Day 3-5 minimal forward model) running in parallel. Kickoff brief: `docs/research_documents/2026-05-05-mcts-path-a-c-kickoff.md`. Sub-plans: `2026-05-05-plan-a-tuner-4p-retool.md`, `2026-05-05-plan-c-day-3-5-minimal-sim.md`.
